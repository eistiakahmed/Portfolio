...
const Projects = () => {
  ...
  const { projects: projectsData, loading, isFromAPI } = useProjects();
    ...
    >
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-start text-left mb-16">
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/5 border border-white/10 rounded-full text-xs font-semibold text-slate-300 mb-4 backdrop-blur-sm shadow-inner">
            <span>My Work</span>
          </div>
