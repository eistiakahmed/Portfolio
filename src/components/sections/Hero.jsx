...
import { ArrowRight, Download, Zap, Palette } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              AI-driven full-stack developer specializing in React, Next.js, Node.js,
              and PostgreSQL. I build scalable, secure web applications with focus on
              system design, performance optimization, and modern best practices.
              Turning complex ideas into production-ready solutions.
            </motion.p>
            ...
            >
              ...
              <motion.button
                ...
                className="group inline-flex items-center justify-center gap-2 px-8 py-3 bg-white/5 border border-white/10 text-slate-300 font-semibold rounded-lg relative overflow-hidden hover:bg-white/10 transition-colors"
          ...
          >
            ...
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 max-w-full aspect-square">
